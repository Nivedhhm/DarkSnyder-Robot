...
from Darksnyder_Robot.database._utils import get_size
from Darksnyder_Robot.database.autofilter_db import get_search_results, is_subscribed
...
@DarkSnyder_Robot.on_inline_query(Worker.user(AUTH_USERS) if AUTH_USERS else None)
